...
import type { ITripRepository, CreateTripData, UpdateTripData } from '../../application/ports/repositories/trip.repository';
import { tripInclude, tripSummarySelect } from '../../application/ports/repositories/trip.repository';
